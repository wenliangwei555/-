...
import cn.baisee.oa.importExcel.filter.validator.CheckMobileAndCertValidator;
/**
 * 加载
 * @author Administrator
 *
 */
public class BaseCheckFilterChain extends AbstractFilterChain<BaseDto, RowValidateResultDto> {

	
	public BaseCheckFilterChain(ICIPContext context) {
		init(context);
	}
	...
	private void init(ICIPContext context) {
		/** 基础性数据校验器 */
		this.filters.add(new CheckMobileAndCertValidator());
	}
}
