...
public class AuditionStudentCheckMobileAndCertValidator extends AbstractValidator<BaiseeAuditionStudent, RowValidateResultDto>{
	...
	@Override
	protected RowValidateResultDto validate(BaiseeAuditionStudent dto) {
	 ...
	 * @return
	 */
	private CellValidateResultDto checkMobile(BaiseeAuditionStudent dto) {
	 ...
	 * @return
	 */
	private CellValidateResultDto checkIsNull(BaiseeAuditionStudent dto) {
		
		String name = dto.getName();
		//如果有一个不为空
		if (StringUtils.isNotEmpty(name)) {
			if ( StringUtils.isEmpty(name)) {
				return new CellValidateResultDto("输入信息时,姓名必填");
			}
		}
		return null;
	}
	 ...
	 * @return
	 */
	private CellValidateResultDto checkCert(BaiseeAuditionStudent dto) {
	 ...
	 * @return
	 */
	private boolean checkCard(BaiseeAuditionStudent dto) {
