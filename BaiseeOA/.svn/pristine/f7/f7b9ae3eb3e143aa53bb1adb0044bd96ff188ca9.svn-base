 ...
 *
 */
public class EmpCheckMobileAndCertValidator extends
		AbstractValidator<ImportEmpModel, RowValidateResultDto> {
	...
	@Override
	protected RowValidateResultDto validate(ImportEmpModel dto) {
	 ...
	 * @return
	 */
	private CellValidateResultDto checkMobile(ImportEmpModel dto) {
	 ...
	 * @return
	 */
	private CellValidateResultDto checkIsNull(ImportEmpModel dto) {
		String certNo = dto.getID();
	 ...
	 * @return
	 */
	private CellValidateResultDto checkCert(ImportEmpModel dto) {
		String certNo = dto.getID();
	 ...
	 * @return
	 */
	private boolean checkCard(ImportEmpModel dto) {
		String pCardNo = dto.getID();// 身份证号码
