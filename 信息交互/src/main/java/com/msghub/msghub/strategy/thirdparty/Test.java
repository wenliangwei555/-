...
public class Test {
     ...
     * @return
     */
    private static Result messaging(Result setResult) {
    ...
    public static void main(String[] args) {
        ...
        Business bean = annotationConfigApplicationContext.getBean(Business.class);
        System.out.println(bean.getBid());


        String regex6 = "[1-9]\\d{7,10}@qq\\.com";
        String s7 = "3094522799@qq.com";
        System.out.println(s7.matches(regex6));
        String[] arr = {""};//"1851093896@qq.com", "1814097834@qq.com", "908722902@qq.com"
        IStrategy mail = new Mail();
        Parameter parameter = new Parameter();
        parameter.setReceived(arr);//接收人
        parameter.setLstrategy(mail);//发送策略
        parameter.setClient_id("1");//公司标识
        parameter.setTemplate_id("3");//模板
        Map<Object, Object> map = parameter.getMap();
        map.put("codeb", "");//累不死
        map.put("coded", "");//圣诞节
        map.put("codea", "");//橡树玫瑰城
        parameter.setMap(map);//变量
        JSONObject obj = new JSONObject().fromObject(parameter);//将json字符串转换为json对象
        System.out.println(
                obj
        );
        //language=JSON
       // String name = "{\"client_id\":\"1\",\"lstrategy\":{\"channel\":\"3\"},\"map\":{\"coded\":\"圣诞节\",\"codeb\":\"马化腾\",\"codea\":\"橡树玫瑰城\"},\"received\":[\"1851093896@qq.com\",\"1814097834@qq.com\",\"908722902@qq.com\"],\"template_id\":\"3\",\"userid\":\"\"}";
       // JSONObject jsStr = JSONObject.fromObject(name);
        Map<Object,Object> maps=new HashMap();
        map.put("IStrategy", IStrategy.class);
        Parameter jb =  (Parameter)JSONObject.toBean(obj,Parameter.class,maps);//将建json对象转换为Person对象
        System.out.println(jb);
        //IStrategy lstrategy = jb.getLstrategy();
        // System.out.println(lstrategy.channel);
        // 用户账号
        String userid = "E10AHD";
        // 用户密码
        String pwd = "4YrWwY";
        //主IP信息  必填
        ...
        // 单条发送
        //singleSend(userid, pwd,"您的注册验证码是YZM，在GQSJ分钟内输入有效。如非本人操作请忽略此短信。", isEncryptPwd,"18348704032");
     ...
     * @description 单条发送
     */
    public static Integer singleSend(String userid, String pwd, String text, boolean isEncryptPwd, String Cellphonenumber) {
        try {
            // 参数类
            ...
            // 设置手机号码 此处只能设置一个手机号码
            message.setMobile(Cellphonenumber);
            // 设置内容
     ...
     * @description 相同内容群发
     */
    public static Integer batchSend(String userid, String pwd, String text, boolean isEncryptPwd, String Cellphonenumber) {
        try {
            // 参数类
            Message message = new Message();
            // 实例化短信处理对象
